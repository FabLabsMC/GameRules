...
public abstract class EditGameRulesScreen$RuleListWidget$RuleTypeConsumerMixin implements GameRules.RuleTypeConsumer, FabricRuleTypeConsumer {
	...
	/**
	 * @reason We serialize enum rules as their ordinal. So we need to display their constant name for the tooltip
	 */
	...
	private <T extends GameRules.Rule<T>> String enumRule$properDefaultDisplay(GameRules.Rule<T> rule) {
